...
const features: Feature[] = [
  {
    icon: Calendar,
    title: 'Easy Booking',
    description: 'Schedule services in seconds. Pick your time, and we handle the rest.',
  ...
  },
  {
    ...
    description: 'Chat directly with your assigned professional before and during service.',
  ...
  },
  {
    ...
    description: 'Pay securely through the app. No cash needed, no hidden fees.',
